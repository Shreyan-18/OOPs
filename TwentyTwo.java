...
public class TwentyTwo 
{
    ...
    {
        Track heavyTruck = new Track("Volvo", "Commercial", 120, 85000.00, 6.5, "TRK-9988", 15.5, "Box Hood", 10);
        System.out.println("--- Track Information ---");
        heavyTruck.printDetails();

        System.out.println();

        Car sedan = new Car("Toyota", "Personal", 180, 24000.00, 35.0, "CAR-1122", 4, 5);
